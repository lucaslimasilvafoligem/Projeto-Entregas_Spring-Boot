...
@Service
public class PedidoListarPorStatusPadraoService implements PedidoListarPorStatusService {
    @Autowired
    ...
    public List<Pedido> listar(Long clienteId, Long estabelecimentoId, Long pedidoId, String pedidoStatusEntrega)
            throws
        ...
        List<Pedido> pedidos = pedidoRepository.findAll()
                .stream()
                .filter(item -> item.getClienteId().equals(clienteId) && item.getStatusEntrega().equals(pedidoStatusEntrega))
